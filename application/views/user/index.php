        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                ...
                <div class="col-md-11 ftco-animate text-center">
                    <h1 class="mb-4">Highest Quality Care For Pets You'll Love. Wellcome to Our PetShop! </h1>
                ...
                <div class="col-md-6 d-flex align-self-stretch px-4 ftco-animate">
                    <div class="d-block services text-center">
                        ...
                        <div class="media-body">
                            ...
                            <a href="<?= base_url('user/product') ?>" class="btn-custom d-flex align-items-center justify-content-center"><span
