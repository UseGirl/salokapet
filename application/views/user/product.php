		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-end">
				<div class="col-md-9 ftco-animate pb-5">
					<p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?= base_url('user') ?>">Home <i
									class="ion-ios-arrow-forward"></i></a></span> <span>Product <i
				...
				<div class="col-md-4 d-flex ftco-animate">
					<div class="blog-entry align-self-stretch">
						<a href="blog-single.html" class="block-20 rounded"
							style="background-image: url('../assets/product/<?= $prd['gambar']; ?> ');">
						</a>
						<div class="text p-4">
							<div class="meta mb-2">
								<div>
							...
							<div class="meta mb-2">
								<div>
									<p>Rp. <?= $prd['harga']; ?> | Stok : <?= $prd['jumlah_stok']; ?> | Kategori :
										...
										<?php if ($prd['id_kategori'] == $ktg['id_kategori']) : ?>
										<!-- Display details related to the current order -->
												<?= $ktg['nama_kategori']; ?>
										<?php endif; ?>
							...
							<form action="<?= base_url('user/order') ?>" method="post">
								...
								<input type="hidden" name="jumlah_stok[]" value="<?= $prd['jumlah_stok']; ?>">
								<input type="hidden" name="harga[]" value="<?= $prd['harga']; ?>">
								<?php if ($prd['jumlah_stok'] != 0) : ?>

								<input type="number" name="jumlah[]" class="form-control col-md-6" min="1"
									max="<?= $prd['jumlah_stok']; ?>" placeholder="How many?" required>
								<button type="submit" name="Add" class="btn btn-primary mt-2">Place Order</button>
								<?php else : ?>
								<button type="submit" name="Add" class="btn btn-danger mt-2" disabled>Sold Out</button>
								<?php endif; ?>
							</form>
			...
			<div class="row">
				...
				<div class="col-md-4 col-lg-4 pl-lg-5 mb-4 mb-md-0">
					...
					<ul class="list-unstyled">
						...
						<li><a href="<?= base_url('user/contact') ?>" class="py-2 d-block">Contact</a></li>
					</ul>
				</div>
				<div class="col-md-4 col-lg-4 mb-4 mb-md-0">
